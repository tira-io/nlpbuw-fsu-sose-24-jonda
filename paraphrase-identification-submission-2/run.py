import subprocess
from transformers import MobileBertTokenizer, MobileBertForSequenceClassification, AutoModelForSequenceClassification, AutoTokenizer
import torch
import pandas as pd
...
if __name__ == "__main__":
    ...
    df["label"] = predictions.numpy()  # Rename the prediction column to avoid conflict
